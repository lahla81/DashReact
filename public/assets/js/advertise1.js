$(document).ready(function () {
    ...
    var circle = document.getElementById("customCheck-circle");
    var half = document.getElementById("customCheck-half");
    var bar = document.getElementById("customCheck-bar");
    var line = document.getElementById("customCheck-line");    
    ...
    var input = document.getElementsByName("notary");
    ...
    $('input[name="notary"]').click(function inputClick(){
        ...
        half.addEventListener("click", halfFunc);
        ...
        circle.addEventListener("click", circleFunc);
